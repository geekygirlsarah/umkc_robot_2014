...
cd "/home/umkc/umkc_robot_2014_arduino/wesley/ros/src/rosserial/rosserial_python"
...
/usr/bin/env \
    ...
    build --build-base "/home/umkc/umkc_robot_2014_arduino/wesley/ros/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
