...
cd "/home/umkc/umkc_robot_2014_arduino/wesley/ros/src/rosserial/rosserial_client"
...
/usr/bin/env \
    ...
    build --build-base "/home/umkc/umkc_robot_2014_arduino/wesley/ros/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
