...
if("TRUE" STREQUAL "TRUE")
  set(phidgets_ir_SOURCE_PREFIX /home/umkc/umkc_robot_2014_arduino/wesley/ros/src/phidgets_drivers/phidgets_ir)
  set(phidgets_ir_DEVEL_PREFIX /home/umkc/umkc_robot_2014_arduino/wesley/ros/devel)
  ...
  set(phidgets_ir_INSTALL_PREFIX /home/umkc/umkc_robot_2014_arduino/wesley/ros/install)
...
if(NOT "/home/umkc/umkc_robot_2014_arduino/wesley/ros/src/phidgets_drivers/phidgets_ir/include" STREQUAL "")
  set(phidgets_ir_INCLUDE_DIRS "")
  set(_include_dirs "/home/umkc/umkc_robot_2014_arduino/wesley/ros/src/phidgets_drivers/phidgets_ir/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'phidgets_ir' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/umkc/umkc_robot_2014_arduino/wesley/ros/src/phidgets_drivers/phidgets_ir/${idir}'.  Ask the maintainer 'Murilo F. M. <muhrix@gmail.com>, Ivan Dryanovski <ccnyroboticslab@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND phidgets_ir_LIBRARIES ${${phidgets_ir_dep}_LIBRARIES})
...
if(phidgets_ir_LIBRARIES)
  _remove_duplicate_libraries(phidgets_ir_LIBRARIES phidgets_ir_LIBRARIES)
endif()
